...
//	class GUI
//	{
//		singleConnectedEntityGroup activeButtonList{ creator::createEntity(0), L"pressedButton" };
//	public:
//		display dp;
//
//		nodeBoard workBoard;
...
//		
//		std::map<std::wstring, singleConnectedEntity> parameterSet;//список параметров nechto
//		
//		singleConnectedEntityGroup dropListGroup{ creator::createEntity(0), L"dropList" };
//
